...
pushd $WINEPREFIX/drive_c/electrum-bte
...
LOCALE="$WINEPREFIX/drive_c/electrum-bte/electrum/locale/"
...
cd dist
mv electrum-bte-setup.exe $NAME_ROOT-$VERSION-setup.exe
cd ..
