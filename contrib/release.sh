...
# create tarball
tarball="Electrum-BTE-$VERSION.tar.gz"
...
srctarball="Electrum-BTE-sourceonly-$VERSION.tar.gz"
...
# appimage
appimage="electrum-BTE-$REV-x86_64.AppImage"
...
# windows
win1="electrum-BTE-$REV.exe"
win2="electrum-BTE-$REV-portable.exe"
win3="electrum-BTE-$REV-setup.exe"
...
# android
apk1="Electrum-BTE-$VERSION.0-armeabi-v7a-release.apk"
apk1_unsigned="Electrum-BTE-$VERSION.0-armeabi-v7a-release-unsigned.apk"
apk2="Electrum-BTE-$VERSION.0-arm64-v8a-release.apk"
apk2_unsigned="Electrum-BTE-$VERSION.0-arm64-v8a-release-unsigned.apk"
