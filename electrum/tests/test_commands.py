...
class TestCommands(ElectrumTestCase):
    ...
    def test_setconfig_non_auth_list(self):
        self.assertEqual(['file:///var/www/', 'https://bitwebcore.net'],
            Commands._setconfig_normalize_value('url_rewrite', "['file:///var/www/','https://bitwebcore.net']"))
        self.assertEqual(['file:///var/www/', 'https://bitwebcore.net'],
            Commands._setconfig_normalize_value('url_rewrite', '["file:///var/www/","https://bitwebcore.net"]'))
    ...
    def test_setconfig_auth(self):
        ...
        self.assertEqual("['file:///var/www/','https://bitwebcore.net']",
            Commands._setconfig_normalize_value('rpcpassword', "['file:///var/www/','https://bitwebcore.net']"))
