...
class ElectrumQmlApplication(QGuiApplication):
    ...
    def __init__(self, args, config, daemon, plugins):
        ...
        qmlRegisterType(QEWallet, 'org.electrum_bte', 1, 0, 'Wallet')
        qmlRegisterType(QEWalletDB, 'org.electrum_bte', 1, 0, 'WalletDB')
        qmlRegisterType(QEBitcoin, 'org.electrum_bte', 1, 0, 'Bitcoin')
        qmlRegisterType(QEQRParser, 'org.electrum_bte', 1, 0, 'QRParser')
        qmlRegisterType(QEFX, 'org.electrum_bte', 1, 0, 'FX')
        qmlRegisterType(QETxFinalizer, 'org.electrum_bte', 1, 0, 'TxFinalizer')
        qmlRegisterType(QEInvoice, 'org.electrum_bte', 1, 0, 'Invoice')
        qmlRegisterType(QEInvoiceParser, 'org.electrum_bte', 1, 0, 'InvoiceParser')
        qmlRegisterType(QEUserEnteredPayment, 'org.electrum_bte', 1, 0, 'UserEnteredPayment')
        qmlRegisterType(QEAddressDetails, 'org.electrum_bte', 1, 0, 'AddressDetails')
        qmlRegisterType(QETxDetails, 'org.electrum_bte', 1, 0, 'TxDetails')
        qmlRegisterType(QEChannelOpener, 'org.electrum_bte', 1, 0, 'ChannelOpener')
        qmlRegisterType(QELnPaymentDetails, 'org.electrum_bte', 1, 0, 'LnPaymentDetails')
        qmlRegisterType(QEChannelDetails, 'org.electrum_bte', 1, 0, 'ChannelDetails')
        qmlRegisterType(QESwapHelper, 'org.electrum_bte', 1, 0, 'SwapHelper')
        qmlRegisterType(QERequestDetails, 'org.electrum_bte', 1, 0, 'RequestDetails')
        qmlRegisterType(QETxRbfFeeBumper, 'org.electrum_bte', 1, 0, 'TxRbfFeeBumper')
        qmlRegisterType(QETxCpfpFeeBumper, 'org.electrum_bte', 1, 0, 'TxCpfpFeeBumper')
        qmlRegisterType(QETxCanceller, 'org.electrum_bte', 1, 0, 'TxCanceller')

        qmlRegisterUncreatableType(QEAmount, 'org.electrum_bte', 1, 0, 'Amount', 'Amount can only be used as property')
        qmlRegisterUncreatableType(QENewWalletWizard, 'org.electrum_bte', 1, 0, 'QNewWalletWizard', 'QNewWalletWizard can only be used as property')
        qmlRegisterUncreatableType(QEServerConnectWizard, 'org.electrum_bte', 1, 0, 'QServerConnectWizard', 'QServerConnectWizard can only be used as property')
        qmlRegisterUncreatableType(QEFilterProxyModel, 'org.electrum_bte', 1, 0, 'FilterProxyModel', 'FilterProxyModel can only be used as property')
        qmlRegisterUncreatableType(QSortFilterProxyModel, 'org.electrum_bte', 1, 0, 'QSortFilterProxyModel', 'QSortFilterProxyModel can only be used as property')
